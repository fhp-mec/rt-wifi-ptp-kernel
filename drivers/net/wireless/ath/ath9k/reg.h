...
#define AR_SREV(_ah) \
	((AR_SREV_9100(_ah)) ? 0x0600 : (AR_SREV_9340(_ah) ? 0x400c : 0x4020))

#define AR_SREV_ID(_ah) ((AR_SREV_9100(_ah)) ? 0x00000FFF : 0x000000FF)
...
#define AR_RTC_RC(_ah) ((AR_SREV_9100(_ah)) ? (AR_RTC_BASE + 0x0000) : 0x7000)
...
#define AR_RTC_STATUS_M(_ah) ((AR_SREV_9100(_ah)) ? 0x0000003f : 0x0000000f)
...
#define AR_AGG_WEP_ENABLE_FIX \
	0x00000008 /* This allows the use of AR_AGG_WEP_ENABLE */
...
#define AR_PHY_AGC_CONTROL(_ah)                                   \
	(AR_SREV_9300_20_OR_LATER(_ah) ? AR9003_PHY_AGC_CONTROL : \
...
#define AR_PHY_AGC_CONTROL_EXT_NF_PWR_MEAS \
	0x00040000 /* extend noise floor power measurement */
#define AR_PHY_AGC_CONTROL_CLC_SUCCESS \
	0x00080000 /* carrier leak calibration done */
